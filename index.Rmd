...
### Asociación entre dos variables categóricas - Prueba Chi Cuadrado
...
Como se mencionó en la sección de [tipos de variables](#variables) de este curso, en las ciencias de la salud es bastante frecuente encontrarse con variables categóricas, como el sexo, la raza, lugar de procedencia, categoría laboral, etc. Las variables categóricas pueden clasificarse en:
