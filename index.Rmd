...
knitr::include_graphics("https://github.com/estadisticaun/AlbertoR/blob/main/public/img/who-am-i/user-picture-2.jpg") 
# `r format(Sys.Date(), "%d %B %Y") 
# <i class="fab fa-r-project"></i>
```

Dr Ajay Kumar Koli<br>Assistant Professor<br>Department of Travel & Tourism<br>Vishwakarma University - Pune<br>`r icons::fontawesome$solid$rocket` [@ajay_kolii](https://twitter.com/ajay_kolii)<br>`r icons::fontawesome$solid$rocket` [koliajaykumar@gmail.com](koliajaykumar@gmail.com)
